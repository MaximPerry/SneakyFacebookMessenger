...
function openEmojies() {
    webview.executeJavaScript("triggerclick(document.getElementsByClassName('_30yy _5s2p _39bk')[0]), 'click'");
    console.log('opened Emo');
}